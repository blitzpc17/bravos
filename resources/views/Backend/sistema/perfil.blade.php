...
@section('seccion', 'Administración de Perfiles')
...
@section('bread')
    ...
    <li class="breadcrumb-item"><a href="{{route('perfil.show')}}">Sistema</a></li>
    <li class="breadcrumb-item"><a href="{{route('perfil.show')}}">Perfiles</a></li>
@endsection
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            tabla =  $('#tb-registros').DataTable({
                            ...
                            ajax: "{{url('admin/perfiles/listar')}}",                         
                            columns: [
                               {"data": null},
                               {"data":"nombre"}
                            ],
        ...
        function Modificar(id){
            $.get("{{url('admin/perfiles/obtener/')}}"+"/"+id, function (data) {
                    $("#op").val('M');                    
                    $("#iden").val(data.id);
        ...
        function Eliminar(id){
            $.get("{{url('admin/perfiles/del/')}}"+"/"+id, function (data) {
                var titulo ="";
                var tipo ="";
                if(data.code==200){
                    titulo = "Aviso";
