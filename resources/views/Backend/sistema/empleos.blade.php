...
@section('seccion', 'Administración de empleos')
...
@section('bread')
    ...
    <li class="breadcrumb-item"><a href="{{route('empleos.show')}}">Sistema</a></li>
    <li class="breadcrumb-item"><a href="{{route('empleos.show')}}">Administración Empleos</a></li>
@endsection
...
@push('js')
    ...
    <script>
        ...
        function Modificar(id){
            $.get("{{url('admin/empleos/obtener/')}}"+"/"+id, function (data) {
                    $("#op").val('M');                    
                    $("#iden").val(data.id);
