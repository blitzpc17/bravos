...
@section('seccion', 'Administración de Puestos')
...
@section('bread')
    ...
    <li class="breadcrumb-item"><a href="{{route('puestos.show')}}">Sistema</a></li>
    <li class="breadcrumb-item"><a href="{{route('puestos.show')}}">Puestos</a></li>
@endsection
...
@push('js')
    ...
    <script>
        ...
        function Modificar(id){
            $.get("{{url('admin/puestos/obtener/')}}"+"/"+id, function (data) {
                    $("#op").val('M');                    
                    $("#iden").val(data.id);
        ...
        function Eliminar(id){
            $.get("{{url('admin/puestos/del/')}}"+"/"+id, function (data) {
                var titulo ="";
                var tipo ="";
                if(data.code==200){
                    titulo = "Aviso";
