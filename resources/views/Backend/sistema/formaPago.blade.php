...
@section('seccion', 'Administración de formas de pago')
...
@section('bread')
    ...
    <li class="breadcrumb-item"><a href="{{route('formapago.show')}}">Sistema</a></li>
    <li class="breadcrumb-item"><a href="{{route('formapago.show')}}">Formas de pago</a></li>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>Catálogo de formas de pago</h5>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            tabla =  $('#tb-registros').DataTable({
                            ...
                            ajax: "{{url('admin/formaPago/listar')}}",                         
                            columns: [
                               {"data": null},
                               {"data":"nombre"}
                            ],
        ...
        function Modificar(id){
            $.get("{{url('admin/formaPago/obtener/')}}"+"/"+id, function (data) {
                    $("#op").val('M');                    
                    $("#iden").val(data.id);
        ...
        function Eliminar(id){
            $.get("{{url('admin/formaPago/del/')}}"+"/"+id, function (data) {
                var titulo ="";
                var tipo ="";
                if(data.code==200){
                    titulo = "Aviso";
