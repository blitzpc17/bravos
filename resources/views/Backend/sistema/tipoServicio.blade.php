...
@section('seccion', 'Tipos de servicio')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            tabla =  $('#tb-registros').DataTable({
                            ...
                            ajax: "{{url('admin/tipoServicio/listar')}}",                         
                            columns: [
                               {"data": null},
                               {"data":"nombre"}
                            ],
        ...
        function Modificar(id){
            $.get("{{url('admin/tipoServicio/obtener/')}}"+"/"+id, function (data) {
                    $("#op").val('M');                    
                    $("#iden").val(data.id);
        ...
        function Eliminar(id){
            $.get("{{url('admin/tipoServicio/del/')}}"+"/"+id, function (data) {
                var titulo ="";
                var tipo ="";
                if(data.code==200){
                    titulo = "Aviso";
